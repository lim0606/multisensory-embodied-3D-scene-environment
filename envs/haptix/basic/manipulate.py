...
from envs.haptix import basic_env
...
# model_paths
MODEL_PATHS = {'box': 'basic/MPL_Basic_Random_Box.xml',
               'cylinder': 'basic/MPL_Basic_Random_Cylinder.xml',
               'ellipsoid': 'basic/MPL_Basic_Random_Ellipsoid.xml'}
...
# task class
class ManipulateEnv(basic_env.BasicEnv, utils.EzPickle):
    def __init__(
        self,
        obj_type=None,
        #model_path,
        ...
        """Initializes a new Basic manipulation environment.
...
class BasicBoxEnv(ManipulateEnv):
    #def __init__(self, target_position='random', target_rotation='xyz', reward_type='sparse'):
    def __init__(self):
        super(BasicBoxEnv, self).__init__(
            obj_type='box',  # model_path='MPL_Basic_Random_Box.xml',  # model_path='MPL_Basic.xml',
...
class BasicEllipsoidEnv(ManipulateEnv):
    def __init__(self):
        super(BasicEllipsoidEnv, self).__init__(
            obj_type='ellipsoid',  # model_path='MPL_Basic_Random_Ellipsoid.xml',
            )

class BasicCylinderEnv(ManipulateEnv):
    def __init__(self):
        super(BasicCylinderEnv, self).__init__(
            obj_type='cylinder',  # model_path='MPL_Basic_Random_Cylinder.xml',
            )

class BasicRandomEnv(ManipulateEnv):
    def __init__(self):
        super(BasicRandomEnv, self).__init__(
            obj_type=None,  # model_path=model_path,
            )

class BasicBoxPosCtrlEnv(ManipulateEnv):
    def __init__(self):
        super(BasicBoxPosCtrlEnv, self).__init__(
            obj_type='box',  # model_path='MPL_Basic_Random_Box.xml',
            control_hand_position=True,
            )

class BasicEllipsoidPosCtrlEnv(ManipulateEnv):
    def __init__(self):
        super(BasicEllipsoidPosCtrlEnv, self).__init__(
            obj_type='ellipsoid',  # model_path='MPL_Basic_Random_Ellipsoid.xml',
            control_hand_position=True,
            )

class BasicCylinderPosCtrlEnv(ManipulateEnv):
    def __init__(self):
        super(BasicCylinderPosCtrlEnv, self).__init__(
            obj_type='cylinder',  # model_path='MPL_Basic_Random_Cylinder.xml',
            control_hand_position=True,
            )

class BasicRandomPosCtrlEnv(ManipulateEnv):
    def __init__(self):
        super(BasicRandomPosCtrlEnv, self).__init__(
            obj_type=None,  # model_path=model_path,
            control_hand_position=True,
            )
