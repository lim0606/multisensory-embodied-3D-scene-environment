...
from envs.haptix import shepard_metzler_camera_env
...
# model_paths
TEMPLATE_PATH = 'shepard_metzler/template_camera.xml'
...
# task class
class ManipulateEnv(shepard_metzler_camera_env.ShepardMetzlerEnv, utils.EzPickle):
    def __init__(
        self,
        #model_path,
    ...
    def init(self, info=None):
        ...
        if info is None:
            ...
            for i in range(num_objs):
                ...
                obj_info, obj_elt = self._get_obj_info_elt(_full_path, i, num_parts, rand_pos, do_random_branch=do_random_branch)
                obj_infos += [obj_info]
                obj_elts += [obj_elt]
        ...
        with tempfile.NamedTemporaryFile(suffix=".xml", dir=os.path.join(prefix_path, 'shepard_metzler')) as fp:
            ...
            # init environment
            shepard_metzler_camera_env.ShepardMetzlerEnv.__init__(
                self,
                modified_model_path,
...
class ShepardMetzlerCameraMultiObjsEnv(ManipulateEnv):
    def __init__(self):
        super().__init__(
...
class ShepardMetzlerCameraSingleObjEnv(ManipulateEnv):
    def __init__(self):
        super().__init__(
            #control_hand_position=True,
            control_camera_position=True,
...
class ShepardMetzlerCameraSingleObjP4Env(ManipulateEnv):
    def __init__(self):
        super().__init__(
            #control_hand_position=True,
            control_camera_position=True,
...
class ShepardMetzlerCameraSingleObjP6Env(ManipulateEnv):
    def __init__(self):
        super().__init__(
            #control_hand_position=True,
            control_camera_position=True,
...
class ShepardMetzlerCameraSingleObjRBEnv(ManipulateEnv):
    def __init__(self):
        super().__init__(
            #control_hand_position=True,
            control_camera_position=True,
            ...
            rand_pos=False,
            num_parts=5,
            do_random_branch=True,
            )

class ShepardMetzlerCameraSingleObjRBP4Env(ManipulateEnv):
    def __init__(self):
        super().__init__(
            #control_hand_position=True,
            control_camera_position=True,
...
class ShepardMetzlerCameraSingleObjRBP6Env(ManipulateEnv):
    def __init__(self):
        super().__init__(
            #control_hand_position=True,
            control_camera_position=True,
