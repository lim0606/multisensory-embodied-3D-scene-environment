...
#from envs.haptix import rotations, shepard_metzler_hand_env
from envs.haptix import shepard_metzler_hand_env
...
# model_paths
TEMPLATE_PATH = 'shepard_metzler/template_hand.xml'
...
# task class
class ManipulateEnv(shepard_metzler_hand_env.ShepardMetzlerEnv, utils.EzPickle):
    def __init__(
        self,
        #model_path,
...
class ShepardMetzlerHandMultiObjsEnv(ManipulateEnv):
    def __init__(self):
        super().__init__(
...
class ShepardMetzlerHandSingleObjEnv(ManipulateEnv):
    def __init__(self):
        super().__init__(
            control_hand_position=True,
            #control_camera_position=True,
...
class ShepardMetzlerHandSingleObjP4Env(ManipulateEnv):
    def __init__(self):
        super().__init__(
            control_hand_position=True,
            #control_camera_position=True,
...
class ShepardMetzlerHandSingleObjP6Env(ManipulateEnv):
    def __init__(self):
        super().__init__(
            control_hand_position=True,
            #control_camera_position=True,
...
class ShepardMetzlerHandSingleObjRBEnv(ManipulateEnv):
    def __init__(self):
        super().__init__(
            control_hand_position=True,
            #control_camera_position=True,
...
class ShepardMetzlerHandSingleObjRBP4Env(ManipulateEnv):
    def __init__(self):
        super().__init__(
            control_hand_position=True,
            #control_camera_position=True,
...
class ShepardMetzlerHandSingleObjRBP6Env(ManipulateEnv):
    def __init__(self):
        super().__init__(
            control_hand_position=True,
            #control_camera_position=True,
