...
#from envs.haptix import rotations, toy_hand_env
from envs.haptix import toy_hand_env
...
# model_paths
TEMPLATE_PATH = 'toy/template_hand.xml'
MODEL_PATHS = {
...
# task class
class ManipulateEnv(toy_hand_env.ToyEnv, utils.EzPickle):
    def __init__(
        self,
        #model_path,
...
#class ToyHandMultiObjsEnv(ManipulateEnv):
#    def __init__(self):
#        super().__init__(
...
class ToyHandSingleObjSphereEnv(ManipulateEnv):
    def __init__(self):
        super().__init__(
            control_hand_position=True,
            #control_camera_position=True,
...
class ToyHandSingleObjBoxEnv(ManipulateEnv):
    def __init__(self):
        super().__init__(
            control_hand_position=True,
            #control_camera_position=True,
...
class ToyHandSingleObjCylinderEnv(ManipulateEnv):
    def __init__(self):
        super().__init__(
            control_hand_position=True,
            #control_camera_position=True,
