...
#from envs.haptix import rotations, toy_hand_camera_env
from envs.haptix import toy_hand_camera_env
...
# model_paths
TEMPLATE_PATH = 'toy/template_hand_camera.xml'
MODEL_PATHS = {
...
# task class
class ManipulateEnv(toy_hand_camera_env.ToyEnv, utils.EzPickle):
    def __init__(
        self,
        #model_path,
...
#class ToyHandCameraMultiObjsEnv(ManipulateEnv):
#    def __init__(self):
#        super().__init__(
...
class ToyHandCameraSingleObjSphereEnv(ManipulateEnv):
    def __init__(self):
        super().__init__(
            control_hand_position=True,
            control_camera_position=True,
...
class ToyHandCameraSingleObjBoxEnv(ManipulateEnv):
    def __init__(self):
        super().__init__(
            control_hand_position=True,
            control_camera_position=True,
...
class ToyHandCameraSingleObjCylinderEnv(ManipulateEnv):
    def __init__(self):
        super().__init__(
            control_hand_position=True,
            control_camera_position=True,
