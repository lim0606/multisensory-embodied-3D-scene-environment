...
class CameraCtrlEnv(haptix_env.HaptixEnv):
    def __init__(self,
                 model_path,
                 n_substeps,
                 initial_qpos,
        ...
        # init class
        super(CameraCtrlEnv, self).__init__(
        ...
        if self.control_hand_position and self.control_camera_position:
            self.position_ctrlrange = np.array(
                    [[-0.01, 0.01],  # MPL hand x-axis
                     ...
                     [-0.01, 0.01],  # camera x-axis
                     [-0.01, 0.01],  # camera y-axis
                     [-0.01, 0.01],  # camera z-axis
                     ])
        elif self.control_hand_position or self.control_camera_position:
            self.position_ctrlrange = np.array(
                    [[-0.01, 0.01],  # MPL hand or camera x-axis
                     [-0.01, 0.01],  # MPL hand or camera y-axis
                     [-0.01, 0.01],  # MPL hand or camera z-axis
                     ])
        else:
