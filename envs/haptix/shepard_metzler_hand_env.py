...
class ShepardMetzlerEnv(haptix_env.HaptixEnv):
    def __init__(self,
                 model_path,
                 n_substeps,
                 initial_qpos,
        ...
        # viewer setup
        self.use_defined_camera = False #True
    ...
    def _viewer_setup(self):
        ...
        if not self.use_defined_camera:
            #body_id = self.sim.model.body_name2id('obj0-part0')
            #body_id = self.sim.model.body_name2id('rgb_camera_arm')
            #lookat = self.sim.data.body_xpos[body_id]
            #for idx, value in enumerate(lookat):
            #    self.viewer.cam.lookat[idx] = value
            if hasattr(self,'viewer_lookat'):
                self.viewer.cam.lookat[0] = self.viewer_lookat[0]
                self.viewer.cam.lookat[1] = self.viewer_lookat[1]
                self.viewer.cam.lookat[2] = self.viewer_lookat[2]
            self.viewer.cam.distance = 1.  # 0.5
