...
# model_paths
TEMPLATE_PATH = 'rooms/template_hand.xml'
...
# task class
class ManipulateEnv(rooms_hand_env.RoomsEnv, utils.EzPickle):
    def __init__(
        self,
        #model_path,
    ...
    def _reset_sim(self):
        ...
        for _ in range(10):
            ...
            if self.control_hand_position:
                action[self.n_actuators:] = self.init_mpos[0].reshape(self.n_positions,)[:]
...
class RoomsHandMultiObjsEnv(ManipulateEnv):
    def __init__(self):
        super().__init__(
...
class RoomsHandSingleObjEnv(ManipulateEnv):
    def __init__(self):
        super().__init__(
            control_hand_position=True,
            #control_camera_position=True,
